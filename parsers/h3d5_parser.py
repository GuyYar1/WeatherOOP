...
class H3D5_Parser(BaseParser):
    ...
    def __init__(self, city_name: str = None, country_code: str = None , state_name: str = None):
    ...
    async def fetch_data(self):
        ...
        apicall = ApiGatewayManager(wc, self.city_name, self.country_code, self.state_name)
        # Consider to remove or think why class is needed here and not static methods utils
        apicall.get_weatherbycity(wc, self.city_name, self.country_code, self.state_name)
